 ...
 */
public class KamiColourPickerButtonUI extends AbstractComponentUI<ColourPickerButton> {
    ...
    public void renderComponent(ColourPickerButton component, FontRenderer fontRenderer) {
        ...
        if (modeComponent == null || !modeComponent.equals(component)) {
            ...
            normalFontRenderer.drawString(component.getWidth() / 2 - fontRenderer.getStringWidth(component.getIndexMode()) / 2, 0,c,  "\u00A7" + component.getIndexMode() + component.getIndexMode());
        }
    ...
    @Override
    public void handleSizeComponent(ColourPickerButton component) {
        int width = 0;
    ...
    @Override
    public void handleAddComponent(ColourPickerButton component, Container container) {
